                        ...
                        <div class="flex w-full">
                            ...
                            <div class="flex items-center ml-7 mr-2">
                                <div class="relative">
                                    ...
                                    <input type="search" name="q" class="border border-gray-300 bg-gray-200 py-2 text-sm rounded-md pl-10 rounded-md transition ease-in-out duration-150 sm:text-sm sm:leading-5" placeholder="Search..." autocomplete="off">
                                </div>
                            </div>
                        </div>

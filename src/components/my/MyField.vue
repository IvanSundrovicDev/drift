<template>
  <div class="flex">
    <div
      ...
      class="w-full field-item pt-8 pb-2 text-center mx-8 border-b-2 border-gray-200 cursor-pointer"
    ...
    <div class="fixed dots">
      <font-awesome-icon
        class="fa-2x hover:text-drift-blue cursor-pointer"
        icon="ellipsis-h"
        v-on:click="activatePopup()"
      ></font-awesome-icon>
      <div
        v-if="activePopup === field.id"
        class="flex ml-11 -mt-11"
      >
        ...
        <div class="bg-white rounded-lg">
          <div v-if="!open" class="mx-3">
            ...
            <div class="flex list-item my-4 p-2 rounded-md hover:bg-red-500 hover:text-white cursor-pointer">
              <Delete class="my-auto invert-to-white mr-4" />
              <h1 class="text-xl">Delete field</h1>
            </div>
            <div class="flex list-item my-4 p-2 rounded-md hover:bg-drift-blue hover:text-white cursor-pointer">
